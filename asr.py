# import from https://github.com/FairyDevicesRD/mimi.example.python/blob/e2e04bae640ec2b23d02cb8a41da9038dacd8cac/asr.py
# and modified by emergent
...
if __name__ == '__main__':
    ...
    try:
        ...
        resp_text = ''.join(map(
            lambda x: x["result"].split('|')[0], resp_json["response"]))
        print(args[2], resp_text)
